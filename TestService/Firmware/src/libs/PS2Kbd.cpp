...
volatile int dbg_cnt_1;
volatile int dbg_cnt_2;
volatile int dbg_cnt_3;
volatile int dbg_cnt_4;
volatile int dbg_cnt_5;
...
void PS2Kbd::begin()
{
    ...
    {
        keyboard0Ptr = this;
        attachInterrupt(digitalPinToInterrupt(clkPin), kbdInterrupt0, RISING);
    }
